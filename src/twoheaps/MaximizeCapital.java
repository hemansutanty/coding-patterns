...
public class MaximizeCapital {
    ...
    public static int findMaximumCapital(int[] capital, int[] profits, int numberOfProjects, int initialCapital) {
        ...
        PriorityQueue<Integer> minCapitalHeap = new PriorityQueue<>(capital.length,(a,b)->capital[a]-capital[b]);
        PriorityQueue<Integer> maxProfitHeap= new PriorityQueue<>(capital.length,(a,b)->profits[b]-profits[a]);
